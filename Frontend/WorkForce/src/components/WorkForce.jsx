...
const WorkForce = () => {
  ...
  const [workers, setWorkers] = useState([
    {
      ...
      status: 'Available',
      competencies: ['IPC', 'Case Management'],
    ...
    },
    {
      ...
      district: 'Blantyre',
      facility: 'Queen Elizabeth Central',
      phone: '+265 992 345 678',
      status: 'Deployed',
      competencies: ['Vaccination', 'Testing'],
    ...
    },
    {
      ...
      district: 'Mzuzu',
      facility: 'Mzuzu Central Hospital',
      phone: '+265 993 456 789',
      status: 'Available',
      competencies: ['IPC', 'Case Management', 'Surveillance'],
    ...
    },
    {
      ...
      status: 'On Leave',
      competencies: ['Contact Tracing'],
      lastTraining: '2024-01-30'
    },
    {
      id: 5,
      name: 'David Jere',
  ...
  const handleViewDetails = (worker) => {
    ...
    alert(`Viewing details for ${worker.name}`);
  };

  const handleAddWorker = () => {
    console.log('Add new worker');
    // Implement add worker functionality
    alert('Add new worker form would open here');
  };
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              {filteredWorkers.map((worker) => (
                <tr key={worker.id} className="hover:bg-gray-50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {new Date(worker.lastTraining).toLocaleDateString()}
                  </td>
        ...
        onSuccess={() => {
          ...
          // Refresh your workforce data here
          console.log('Healthcare worker added successfully!');
        }}
      />
